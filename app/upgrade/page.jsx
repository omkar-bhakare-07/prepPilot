...
import pricingPlans from './_components/PricingPlan'; // Ensure this is an array, not a component
      ...
      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
          {pricingPlans.map((item, index) => {
            ...
            const fullUrl = `${item.link}${separator}prefilled_email=${encodeURIComponent(email)}`;

            return (
              <div
                key={index}
                className="rounded-2xl border border-gray-200 p-6 shadow-xs sm:px-8 lg:p-12"
              >
